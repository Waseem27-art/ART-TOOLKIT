...
iLO Exploitation
https://github.com/airbus-seclab/ilo4_toolbox https://www.exploit-db.com/exploits/44005
...
EDR Evasion: Unhooking DLL's With CSharp

Playing With An EDR: Cylance

Full DLL Unhooking With C++

Data Only Attack: Neutralizing EtwTi Provider

Beginner's Guide To EDR Evasion
...
Evading EDR With Inline Hooks)

Thread Local Storage - MSDN)

Thread Local Storage 2 - Explicit TLS)

OverviewInterception)

EDR - A Closer Look At Protect Services)

FindETWProviderImage)

ETW Bypasses)

Another method of bypassing ETW](https://modexp.wordpress.com/2020/04/08/red-teams-etw/)](https://modexp.wordpress.com/2020/04/08/red-teams-etw/)](https://modexp.wordpress.com/2020/04/08/red-teams-etw/) "https://modexp.wordpress.com/2020/04/08/red-teams-etw/)](https://modexp.wordpress.com/2020/04/08/red-teams-etw/)")
...
Bypassing Cylance and Other EDR-AV)

Detecting Hooked Syscalls)

Windows X86-X64 System Call Table)

Hell's Gate Technique)

Calling Syscalls From Visual Studio)
...
Windows Kernel Ps Callbacks)

Kernel Ps Callback Experiments)

Direct Syscalls in BOFs)

Implementing Syscalls in ArtifactKit)

Cobalt Strike - InlineWhispers ArtifactKit)

Using Inline Assembly in C/C++)

InlineWhispers)

Utilizing Syscalls in CSharp)

Direct Syscalls and sRDI)
